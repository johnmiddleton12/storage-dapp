        ...
        <div className='md:flex justify-between items-center mb-6 md:mb-6 m-6 mt-14 md:mt-[130px]'>
            ...
            <div className='w-full md:w-[full] space-y-5 text-white  bg-jp-gray rounded-2xl p-3.5 font-semibold z-20'>
                ...
                >
                    ...
                    <button className='bg-gray-700 w-full border border-gray-700 rounded-2xl p-2 bg-opacity-90 hover:bg-opacity-80'>
                        {loading ? (
                ...
                <button
                    className='bg-gray-700 w-full border border-gray-700 rounded-2xl p-2 bg-opacity-90 hover:bg-opacity-80'
                    onClick={() => {
