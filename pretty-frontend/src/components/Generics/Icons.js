...
export function ErrorIcon(props) {
  return (
    <div className="flex flex-col items-center group">
      ...
      <div className="absolute flex-col items-center hidden group-hover:flex">
...
export function LoadingIcon(props) {
    return (
        <div role='status'>
            <svg
                aria-hidden='true'
                className={`w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 ${props.className}`}
                viewBox='0 0 100 101'
                fill='none'
                // xmlns='http://www.w3.org/2000/svg'
            >
